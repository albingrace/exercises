# -*- coding: utf-8 -*-
"""
Created on Sun Mar 23 01:31:14 2014
...
#
#
#removelist = set('for a of the and to in online at on learn item items page from'.split())
#texts = [[word for word in line.split() if word not in removelist]
