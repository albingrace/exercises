...
test_txtfile = './data/test_deals.txt'
# combine two deals for the purpose of having common features
filenames = ['./data/good_deals.txt', './data/bad_deals.txt']
...
# generate training matrix with word features and their counts, each text line is one observation
